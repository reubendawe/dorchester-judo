        ...
        <footer class="py-3 px-2">
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center">
                ...
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo get_permalink(139); ?>" class="nav-link text-light">Blog</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="d-flex flex-row justify-content-between py-4 my-4 border-top">
                <p><?php echo date('Y'); ?> Red Panda Judo. All rights reserved.</p>
